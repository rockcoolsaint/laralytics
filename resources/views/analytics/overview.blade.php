        ...
        <div class="grid">
          <div class="col-lg-12 col-xs-12">
            <div class="box-header bg-white" data-toggle="collapse" data-target="#overviewToday">
              <h3 class="box-title">OVERVIEW: Today (First transaction time: <span id="first_transaction_time" class="box-value">2017-10-30 05:24:11</span>)</h3>
        ...
        <div class="collapse in" id="overviewToday">
          <div class="col-lg-4 col-xs-12 hidden-xs">
            ...
            <div id="today_transactions" class="box-margin bg-white">
              ...
              <div class="row">
                <div class="col-lg-4 col-xs-12">
                  ...
                  <div id="pms_transactions" class="purple box-value">20.06</div>
                </div>
                <div class="col-lg-4 col-xs-12">
                  <div class="box-value-heading">Diesel</div>
                  <div id="ago_transactions" class="purple box-value">20.44</div>
                </div>
                <div class="col-lg-4 col-xs-12">
                  <div class="box-value-heading">Kerosene</div>
                  <div id="dpk_transactions" class="purple box-value">20.73</div>
                </div>
              </div>
            </div>
            ...
            <div id="volume" class="box-margin bg-white">
              ...
              <div class="row">
                <div class="col-lg-4 col-xs-12">
                  <div class="box-value-heading">Petrol</div>
                  <div id="pms_volume" class="purple box-value">20.06</div>
                </div>
                <div class="col-lg-4 col-xs-12">
                  <div class="box-value-heading">Diesel</div>
                  <div id="ago_volume" class="purple box-value">20.44</div>
                </div>
                <div class="col-lg-4 col-xs-12">
                  <div class="box-value-heading">Kerosene</div>
                  <div id="dpk_volume" class="purple box-value">20.73</div>
                </div>
              </div>
            </div>
          ...
          <div id="today_revenue" class="col-lg-4 col-xs-12 hidden-xs">
            ...
            <div class="box-margin bg-white">
              ...
              <hr>
              <div class="green box-value">₦&nbsp;<span id="pms_revenue">4,559,495.25</span></div>
            </div>
            ...
            <div class="box-margin bg-white">
              ...
              <hr>
              <div class="green box-value">₦&nbsp;<span id="ago_revenue">4,591,391.25</span></div>
            </div>
            ...
            <div class="box-margin bg-white">
              ...
              <hr>
              <div class="green box-value">₦&nbsp;<span id="dpk_revenue">31,896.25</span></div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-xs-12">
            ...
            <!--<div class="box-margin bg-white">
              ...
              <div class="box-margin bg-white">
                <div class="efizzy"></div>
                <div><h4 class="box-label">No. of Pumps on Site: <span id="num_pumps">3</span></h4></div>
                <hr>
                <div class="balance">
                  <h4 class="box-label">No. of Pumps Selling: <span id="sell_pumps">8</span></h4>
                </div>
              </div> 
