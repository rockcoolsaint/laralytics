  ...
  <!-- Select box for stations -->
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          <p class="ui-widget">
            <!--<input id="stationInput" type="text" list="stations" class="form-control" placeholder="e.g. select station">-->
      ...
      <div class="row">
        ...
        <div class="collapse in" id="overviewToday">
          <div class="col-lg-4 col-xs-12 hidden-xs">
            ...
            <!-- small box -->
            <div id="today_transactions" class="box-body box-margin bg-white">
              <h4><strong>Transactions</strong></h4>
              <div class="row">
                <div class="col-lg-4 col-xs-12">
                  <div><strong>Petrol</strong></div>
                  <h3 id="pms_transactions" class="purple">20.06</h3>
                </div>
                <div class="col-lg-4 col-xs-12">
                  <div><strong>Diesel</strong></div>
                  <h3 id="ago_transactions" class="purple">20.44</h3>
                </div>
                <div class="col-lg-4 col-xs-12">
                  <div><strong>Kerosene</strong></div>
                  <h3 id="dpk_transactions" class="purple">20.73</h3>
                </div>
              </div>
            </div>

            <!-- small box -->
            <div id="volume" class="box-body box-margin bg-white">
              <h4><strong>Volume(Litres)</strong></h4>
              <div class="row">
                <div class="col-lg-4 col-xs-12">
                  <div><strong>Petrol</strong></div>
                  <h3 id="pms_volume" class="purple">20.06</h3>
                </div>
                <div class="col-lg-4 col-xs-12">
                  <div><strong>Diesel</strong></div>
                  <h3 id="ago_volume" class="purple">20.44</h3>
                </div>
                <div class="col-lg-4 col-xs-12">
                  <div><strong>Kerosene</strong></div>
                  <h3 id="dpk_volume" class="purple">20.73</h3>
                </div>
              </div>
            </div>
          </div>
          ...
          <div id="today_revenue" class="col-lg-4 col-xs-12 hidden-xs">
            <!-- small box -->
            <div class="box-body box-margin bg-white">
              <p><strong>Revenue (Petrol)</strong></p>
              <h3 class="green"><strong>₦<span id="pms_revenue">4,559,495.25</span></strong></h3>
            </div>

            <!-- small box -->
            <div class="box-body box-margin bg-white">
              <p><strong>Revenue (Diesel)</strong></p>
              <h3 class="green"><strong>₦<span id="ago_revenue">4,591,391.25</span></strong></h3>
            </div>

            <!-- small box -->
            <div class="box-body box-margin bg-white">
              <p><strong>Revenue (Kerosene)</strong></p>
              <h3 class="green"><strong>₦<span id="dpk_revenue">31,896.25</span></strong></h3>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-xs-12">
            <!-- small box -->
            <div class="box-body box-margin bg-white">
              <h5 class="vol-taken"><strong>First transaction time today</strong></h5>
              <div id="first_transaction_time" class="text-center">
                <h3></h3>
              </div>
            </div>
          </div>
